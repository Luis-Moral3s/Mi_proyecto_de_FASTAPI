...
from schemas.user_shema import UserCreate, UserUpdate, UserResponse
...
def create_user(user_data: UserCreate, session: Session = Depends(get_session)):
    ...
    db_user = User(
        ...
        hashed_password= get_password_hash(user_data.password),    ##user_data.password,  # Aquí deberías hashear la contraseña antes de guardarla
        is_active=True
    )
